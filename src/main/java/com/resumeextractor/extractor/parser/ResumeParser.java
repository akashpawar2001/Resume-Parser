...
public class ResumeParser{
    ...
    public List<String> extractEducation(String text) {
        ...
        String[] educationKeywords = {"B.COM","BE","Bachelor", "Master", "PhD", "B.Sc", "M.Sc", "B.A", "M.A", "Diploma", "Associate", "Degree", "University", "College","QUALIFICATION","Institute","Graduated"};
    ...
    public List<String> extractCurrentCompany(String text) {
